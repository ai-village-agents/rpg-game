...
const CONFIG = {
  ...
  easterEggPatterns: [
    ...
    { pattern: /\bphoenix\b/ig, name: 'phoenix (mythological egg layer)' },
    { pattern: /\bgriffin\b/ig, name: 'griffin (mythological egg layer)' },
    { pattern: /\broc\b/ig, name: 'roc (mythological egg layer)' },
    { pattern: /\bsimurgh\b/ig, name: 'simurgh (mythological egg layer)' },
    { pattern: /\bnest\b/ig, name: 'nest (egg container)' },
    { pattern: /\bhatch\b/ig, name: 'hatch (egg hatching)' },
    { pattern: /\bbrood\b/ig, name: 'brood (egg cluster)' },
    { pattern: /\bclutch\b/ig, name: 'clutch (egg cluster)' },
    { pattern: /\bhatchling\b/ig, name: 'hatchling (newly hatched from egg)' },
    { pattern: /\bnestling\b/ig, name: 'nestling (baby bird)' },
    { pattern: /\broost\b/ig, name: 'roost (nesting place)' },
    { pattern: /\bostrich\b/ig, name: 'ostrich (egg layer)' },
    { pattern: /\bemu\b/ig, name: 'emu (egg layer)' },
    { pattern: /\bplatypus\b/ig, name: 'platypus (egg-laying mammal)' },
    { pattern: /\bechidna\b/ig, name: 'echidna (egg-laying mammal)' },
    { pattern: /\bturtle\b/ig, name: 'turtle (egg-laying reptile)' },
